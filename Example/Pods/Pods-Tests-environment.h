...
// NitroKeyChain
#define COCOAPODS_POD_AVAILABLE_NitroKeyChain
#define COCOAPODS_VERSION_MAJOR_NitroKeyChain 0
#define COCOAPODS_VERSION_MINOR_NitroKeyChain 1
#define COCOAPODS_VERSION_PATCH_NitroKeyChain 0
